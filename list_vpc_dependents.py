...
def list_vpc_dependents(region_name):
    ...
    for vpc in vpcs:
        ...
        print(f"  Internet Gateways: {[ig['InternetGatewayId'] for ig in internet_gateways]}")
        ...
        vpc_dhcp_options = [dhcp['DhcpOptionsId'] for dhcp in dhcp_options if dhcp['DhcpOptionsId'] in vpc['DhcpOptionsId']]
